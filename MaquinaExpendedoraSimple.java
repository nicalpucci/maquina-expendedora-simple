public class MaquinaExpendedoraSimple {
    ...
    public MaquinaExpendedoraSimple() {
        ...
        estacionOrigen = "León";
        estacionDestino = "Moscú";
    }
    
    /**
     * Segundo constructor para crear máquinas con el precio del
     * billete indicado por parámetro, la estación de origen 
     * siempre será  León y la estación de destino indicado por 
     * parámetro.
     */
     ...
     */
    public int setPrecioBillete(int valorPrecioBillete) {
        precioBillete = valorPrecioBillete;
     ...
     */
    public int reducirPrecio(int cantidadDescuento) {
